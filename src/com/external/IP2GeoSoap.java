...
public interface IP2GeoSoap {
     ...
     * @param ipAddress
     * @return
     *     returns com.external.IPInformation
     */
    ...
    @RequestWrapper(localName = "ResolveIP", targetNamespace = "http://ws.cdyne.com/", className = "com.external.ResolveIP")
    @ResponseWrapper(localName = "ResolveIPResponse", targetNamespace = "http://ws.cdyne.com/", className = "com.external.ResolveIPResponse")
